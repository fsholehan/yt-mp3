...
function PrivacyPage() {
  return (
    <div className="mx-10 mt-7">
      ...
      <h1 className="font-medium">Privacy Policy for Download Lagu</h1>

      <p>
        At lagump3dl.com, accessible from lagump3dl.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        lagump3dl.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in lagump3dl.com. This policy is not applicable to
      ...
      <p>
        lagump3dl.com follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, lagump3dl.com uses 'cookies'. These cookies are
      ...
      <h2 className="font-semibold">Our Advertising Partners</h2>
      ...
      <h2 className="font-semibold">Advertising Partners Privacy Policies</h2>

      <p>
        You may consult this list to find the Privacy Policy for each of the
        advertising partners of lagump3dl.com.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on lagump3dl.com, which are sent
      ...
      <p>
        Note that lagump3dl.com has no access to or control over these cookies
      ...
      <p>
        lagump3dl.com's Privacy Policy does not apply to other advertisers or
      ...
      <h2 className="font-semibold">GDPR Data Protection Rights</h2>
      ...
      <p>
        lagump3dl.com does not knowingly collect any Personal Identifiable
